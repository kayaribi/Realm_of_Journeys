...
export default function Navbar({isCartPages}){
    ...
    // 漢堡選單style 
    const hamburgIconClass = isNavbarOpen || isScrolled
    ? `hamburg-icon text-neutral-300`
    : `hamburg-icon text-white`;
    // 購物車style
    const cartIconClass = isNavbarOpen || isScrolled 
    ? "text-neutral-300" 
    : "text-white" ;
    // logo顯示圖片
    ...
    return( <>
        <nav className={`navbar navbar-expand-lg fixed-top navbar-light navbarPadding 
                ...
                <div className="d-flex align-items-center">
                    ...
                    >
                        <i className= {`${isNavbarOpen ? "bi bi-x" : "bi bi-list"} 
                                        ${isCartPages ? "text-neutral-300":hamburgIconClass}`}></i>
                    </button>
                </div>
                ...
                <div className="collapse navbar-collapse" id="navbarContent">
                    <ul className="navbar-nav ms-auto mt-14 mt-lg-0 d-flex align-items-center">
                        <li className="nav-item me-lg-8">
                            <NavLink className={linkActiveColor} to="/travelSpots" onClick={handleLinkClick}>
                                旅遊景點
                            </NavLink>
                        </li>
                        <li>
                        ...
                        <li className="nav-item me-lg-8">
                            <NavLink className={linkActiveColor} to="/travelGuide" onClick={handleLinkClick}>
                                攻略指南
                            </NavLink>
                        </li>
                        <li>
                        ...
                        <li className="nav-item">
                            <NavLink className={linkActiveColor} to="/about" onClick={handleLinkClick}>
                                關於我們
                            </NavLink>
                        </li>
                        {/* 購物車 -lg */}
                        <li className="nav-item d-none d-lg-block cart-lg-margin fs-6">
                            <NavLink to="/cart">
                                <i className="bi bi-cart text-neutral-300 lh-0 p-2"></i>
                            </NavLink>
                        </li>
