...
export default function About() {
  ...
  return (
    <div className="about">
      <header className="about-banner position-relative mb-8 mb-lg-20" id="header">
      ...
      <div className="container">
        <section className="text-lg-center mb-4 mb-lg-20">
          <p className="fs-10 fs-lg-6 mb-4">
            我們致力於為旅客提供一個高效便捷的平台，
            <br />
            省去繁瑣的行程規劃，打造無憂無慮的旅遊體驗。
          </p>
          <p className="fs-10 fs-lg-6">
            我們致力於為旅客提供一個高效便捷的平台，
            <br />
            省去繁瑣的行程規劃，打造無憂無慮的旅遊體驗。
          </p>
        ...
        <section className="mb-lg-20">
          ...
          <div className="row">
            <div className="col-lg-6">
              <img className="d-none d-xl-block" src="images/about_feature_2.jpg" alt="about_feature_2" style={{ maxWidth: "416px", height: "500px", borderRadius: "24px", objectFit: "cover", marginTop: "-86px", marginLeft: "110px" }} />
            </div>
            <div className="col-xl-6 d-flex flex-column justify-content-center">
              <h3 className="text-black title-family mb-4 fs-lg-5">我們的特色</h3>
              <div className="mb-5 mb-lg-6">
                <div className="mb-6">
                  <h5 className="text-primary-600 mb-2 fs-lg-7">全包式服務</h5>
                  <p className="fs-10 fs-lg-9">從交通、住宿到活動安排，一站式解決旅遊需求，讓您只需享受旅程。</p>
                </div>
                <div className="mb-6 mb-lg-6">
                  <h5 className="text-primary-600 mb-2 fs-lg-7">專業行程設計</h5>
                  <p className="fs-10 fs-lg-9">根據市場需求打造精緻路線，涵蓋必看景點與特色體驗。</p>
                </div>
                <div>
                  <h5 className="text-primary-600 mb-2 fs-lg-7">省心操作流程</h5>
                  <p className="fs-10 fs-lg-9">友好的網站介面與即時客服支援，為您提供流暢的預訂體驗。</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-9 mb-lg-20">
          <div className="d-lg-flex flex-lg-row-reverse align-items-center gap-34">
            <div className="content-img-vision mb-4"></div>
            <div className="vision-content">
              <h3 className="text-black title-family mb-4 fs-lg-5">我們的願景</h3>
        ...
        <section className="mb-12 mb-lg-25">
          <h3 className="text-black title-family mb-9 mb-lg-15 fs-lg-5 text-lg-center">開發成員介紹</h3>
          <Swiper
            slidesPerView={1}
            spaceBetween={16}
            autoplay={{
      ...
      <section>
        <div className="content-img-sub">
          <div className="content-sub-content text-center">
            ...
            <div className="d-lg-flex justify-content-center align-items-center gap-lg-6">
              <p className='fs-11 fs-lg-6 text-white mb-4 mb-lg-0'>訂閱我們即可收到更多行程資訊</p>
              <div className="px-3 mb-3 mb-lg-0 px-lg-0 ">
                <div className="input-group">
                  <input
                    type="email"
                    className={`form-control ${isValid ? "" : "is-invalid"} fs-lg-9`}
                ...
                {!isLargeScreen && !isValid && <div className="text-danger mt-1" style={{ fontSize: "10px" }}>{message}</div>}
                {!isLargeScreen && submittedEmail && <div className="text-success mt-1" style={{ fontSize: "10px" }}>您的 Email: {submittedEmail}</div>}
              </div>
            </div>
            {isLargeScreen && !isValid && <div className="text-danger mt-1 fs-lg-7" style={{ fontSize: "10px" }}>{message}</div>}
            {isLargeScreen && submittedEmail && <div className="text-success mt-1 fs-lg-7" style={{ fontSize: "10px" }}>您的 Email: {submittedEmail}</div>}
          </div>
        </div>
      </section>
    </div>
