      ...
      >
        <div className="container">
          ...
          >
            ...
            slidesPerView={1} // 手機版一次顯示 1 個 Slide
            spaceBetween={16} // 卡片間距
            // pagination={{ el: paginationRef.current, clickable: true }} // 指定外部 Pagination
            pagination={pagination}
            modules={[Pagination]}
            direction="horizontal" // 手機版向左滑動換頁
            breakpoints={{
              1024: {
                slidesPerView: 4, // 桌面版一次顯示 4 張卡片
                direction: "horizontal", // 桌面版水平方向滑動
                spaceBetween: 24,
              },
            }}
          >
