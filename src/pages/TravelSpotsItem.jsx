    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // 🔹 每次點選時重新隨機排序並選擇四個
                setRandomProducts(allProducts.sort(() => Math.random() - 0.5).slice(0, 4));
                ...
                <>
                    <div className="row pb-lg-12">
                        ...
                        <div className="col-lg-6">
                            <div className="product-detail pb-6 pb-lg-0">
                                <div className="pb-2 pb-lg-4" style={{ borderBottom: "1px solid #C2DCF5" }}>
                                ...
                                <div className="pt-2 pt-lg-4">
                                    ...
                                    <div className="row pb-lg-12">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="pb-4 pb-lg-0">
                                                <p className="text-neutral-200 text-decoration-line-through pb-1 pb-lg-2 fs-10 fs-lg-9">原價 NT {(product.origin_price * quantity).toLocaleString()}</p>
                                                <div className="d-flex justify-content-between flex-lg-column align-items-center align-items-lg-start">
                                                    <p className="text-neutral-300 fs-10 fs-lg-9">優惠價</p>
                                    ...
                                    <div className="d-flex gap-6 justify-content-between">
                                        <button type="button" className="btn btn-secondary-200 custom-btn-secondary-200 w-100 py-lg-3 px-0">直接購買</button>
                                        <button type="button" className="btn btn-outline-secondary-200 custom-btn-outline-secondary-200 w-100 py-lg-3 px-0">加入購物車</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="product-info pt-12 pt-lg-14 pb-8 pb-lg-15">
                        ...
                        <section className="pb-8 pb-lg-15">
                            <div className="pb-4" style={{ borderBottom: "1px solid #C2DCF5" }}>
                            ...
                            <div className="pt-4 d-flex flex-column gap-6">
                                {product.contents.map((item, index) => {
                                    return (
                                        <div key={index}>
                                            <div>
                                                <h5 className="text-primary-600 pb-2 fs-lg-7">{item.title}</h5>
                        ...
                        <section className="bg-primary-50 py-4 py-lg-10" style={{ border: "1px solid #1B67AE", borderRadius: "24px" }}>
                            <div className="px-3 px-lg-8 pb-lg-12">
                                ...
                                <ul className="pt-3 pt-lg-6 pb-4 pb-lg-0 ps-5 m-0">
                                    <li className="fs-10 fs-lg-9">請確認您的護照有效期限至少為六個月</li>
                                    <li className="fs-10 fs-lg-9">請提前查詢目的地的天氣狀況，並攜帶適合當地氣候的衣物和配件（如雨具或防寒衣物）。</li>
                                    <li className="fs-10 fs-lg-9">攜帶常用藥品、處方藥以及基本急救用品，特別是針對可能的水土不服或長途旅行的不適。</li>
                                    <li className="fs-10 fs-lg-9">建議購買涵蓋醫療、行李遺失、意外等內容的旅行保險，以應對突發狀況。</li>
                                    <li className="fs-10 fs-lg-9">了解並尊重目的地的文化習俗、宗教禁忌與法律規範，避免不必要的麻煩。</li>
                                    <li className="fs-10 fs-lg-9">請攜帶護照影本、行程單、酒店預訂確認書及緊急聯絡電話等文件，以備不時之需。</li>
                                    <li className="fs-10 fs-lg-9">確保手機隨時能聯絡，並記錄當地緊急聯絡號碼和領事館資訊。</li>
                                    <li className="fs-10 fs-lg-9">請準時參與行程安排的活動，避免影響您的權益。</li>
                                </ul>
                            </div>
                            <div className="px-3 px-lg-8">
                                ...
                                <ul className="pt-3 pb-4 pt-lg-6 pb-lg-0 ps-5 m-0">
                                    <li className="fs-10 fs-lg-9">於所選日期41天（含）之前取消，收取手續費5％</li>
                                    <li className="fs-10 fs-lg-9">於所選日期31天～40天之間取消，收取手續費10％</li>
                                    <li className="fs-10 fs-lg-9">於所選日期21天～30天之間取消，收取手續費20％</li>
                                    <li className="fs-10 fs-lg-9">於所選日期2天～20天之間取消，收取手續費30％</li>
                                    <li className="fs-10 fs-lg-9">於所選日期24小時（含）之前取消，收取手續費50％</li>
                                    <li className="fs-10 fs-lg-9">所選日期當天不可取消、更改訂單，亦不得請求退款</li>
                                </ul>
                            </div>
                        </section>
                    </div>
                        ...
                        {isLargeScreen ? (
                            ...
                            >
                                {randomProducts.map((filterProduct) => (
                                    <SwiperSlide key={filterProduct.id} style={{ width: "636px" }}>
                                        <Link to={`/travelSpots/${filterProduct.id}`} style={{ height: "100%" }}>
                                            <div className="px-lg-4 d-lg-flex flex-lg-column" style={{ height: "525px" }}>
                                                ...
                                                <div className="pt-4 pb-2">
                                                    <h3 className="title-family travelSpotCardTitle text-neutral-black" style={{ whiteSpace: "pre-line" }}>
                                                        {filterProduct.title}
                                                    </h3>
                                                </div>
                                                <div className="pb-2">
                                                    {filterProduct.description.split("\n").map((des, index) => (
                                                        <p key={index} className={`${index === 0 ? "mb-sm-0 mb-2" : ""} text-neutral-300 travelSpotCardDescription`}>
                                                            {des}
                                                        </p>
                                                    ))}
                                                </div>
                                                <div className="mt-auto">
                                                    <p style={{ fontSize: "14px" }} className="text-decoration-line-through text-neutral-200">
                                                        原價 NT {filterProduct.origin_price.toLocaleString()}
                                                    </p>
                                                    <p style={{ lineHeight: "1.2" }} className="text-secondary-200 travelSpotCardDiscountPrice fw-bold">
                                                        優惠價 NT {filterProduct.price.toLocaleString()}/{filterProduct.unit}
                                                    </p>
                                                </div>
                                            </div>
                                        </Link>
                                    ...
                                    <div key={filterProduct.id}>
                                        <Link to={`/travelSpots/${filterProduct.id}`} style={{ height: "100%" }}>
                                            <div className="d-flex flex-column">
                                                <div className="productListImgWrap overflow-hidden position-relative">
                                                    <img className="productListImg" src={filterProduct.imageUrl} alt={filterProduct.title} />
                                                    <DepartureTimeDecoration featuredItem={filterProduct} />
                                                </div>
